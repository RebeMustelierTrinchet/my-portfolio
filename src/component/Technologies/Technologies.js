      ...
      <div className={styles.maincontainer}> 
          ...
          <ul className={styles.list__container}>Academic Degrees
            <ul className={styles.sub__list__container}>San Jacinto College
                <li  className={styles.list__item}>Programming Student: Currently pursuing studies in Programming, gaining solid knowledge 
            ...
            <ul  className={styles.sub__list__container}>Career Goals
                <li className={styles.list__item}>Long-Term Goal: Aspiring to become a fullstack developer.</li>
            </ul>
          </ul>
          <ul className={styles.list__container}>Professional Experience
            <ul className={styles.sub__list__container}>Internships
                ...
                where I studied Angular and gained valuable hands-on experience in frontend development.
                </li>
            </ul>
            <ul className={styles.sub__list__container}>Independent Projects
                <li className={styles.list__item}>React Projects: Over the past year, I have been dedicated to independently creating React 
